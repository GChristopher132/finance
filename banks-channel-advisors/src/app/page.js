...
export default function Home() {
  ...
  return (
    <main className="flex flex-col">
      {/* --- Hero Section --- */}
      {/* MODIFICATION: Changed h-[70vh] to h-screen */}
      ...
      <section
        ref={whoRef}
        className="relative z-20 w-full bg-white text-[#0A437B]"
      >
        <div
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2">
            ...
            <div className="order-2 md:order-1 flex flex-col justify-center py-16 sm:py-20 px-6 lg:px-16">
              <div className="max-w-2xl mx-auto md:mr-0 md:ml-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-6">
                  ...
                  <div className="flex flex-col items-center p-6 bg-gray-50 rounded-lg shadow-md">
                    ...
                    <p className="text-gray-600 text-center text-sm">
                      Developing sustainable income strategies and managing assets
            ...
            {/* MODIFICATION: Added 'hidden md:block' to hide on mobile */}
            <div className="order-1 md:order-2 relative min-h-[40vh] md:min-h-0 hidden md:block">
              <Image
                src="/images/family.jpeg" // Replace with your /public/images/family.jpg
      ...
      <section
        ref={servicesRef}
        className="relative z-20 w-full bg-gray-50 text-[#0A437B] py-16 sm:py-20"
      >
        <div
          className={`transition-all duration-1000 ease-in-out ${
            isServicesVisible
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="bg-white border border-gray-200 rounded-lg p-6 shadow-sm hover:shadow-md transition-shadow">
                ...
                <p className="text-gray-600 mb-4">
                  Integrating all aspects of your financial life into one
                  cohesive strategy.
                </p>
                <a
                  href="/services"
      ...
      >
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2">
              ...
              <div className="max-w-2xl mx-auto md:mr-0 md:ml-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-6">
                  ...
                  <div className="flex flex-col items-center">
                    ...
                    <p className="text-gray-600 text-center text-sm">
                      We craft bespoke financial plans that adapt to your
                      evolving needs, ensuring every aspect of your financial
                      life is optimized.
                    </p>
                  </div>
                  ...
                  <div className="flex flex-col items-center">
                    ...
                    <p className="text-gray-600 text-center text-sm">
                      We are dedicated to building long-term partnerships based
                      on trust, transparency, and a deep understanding of your
                      personal goals.
                    </p>
                  </div>
            ...
            <div className="order-1 md:order-2 relative min-h-[40vh] md:min-h-0 hidden md:block">
              <Image
                src="/images/handshake2.jpeg" // Replace with your /public/images/why-us.jpg
      ...
      <section
        ref={ctaRef}
        className="relative z-20 w-full bg-white text-[#0A437B] py-16 sm:py-20"
      >
        <div
          className={`transition-all duration-1000 ease-in-out ${
            isCtaVisible
